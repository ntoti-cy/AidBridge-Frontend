...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      providers: [
        RepositoryProvider<OfflineRepository>(
          create: (_) => OfflineRepository(),
        ),

        RepositoryProvider<SyncRepository>(
          create: (_) =>
              SyncRepository(db: DBHelper(), authService: AuthService()),
        ),
      ],
      child: MultiBlocProvider(
        providers: [
          ...
          BlocProvider<BeneficiaryCubit>(
            create: (_) => BeneficiaryCubit(AuthService()),
          ),
          ...
          BlocProvider<OfflineCubit>(
            create: (context) =>
                OfflineCubit(context.read<OfflineRepository>()),
          ),

          BlocProvider(
            create: (_) => SyncCubit(
              SyncRepository(authService: AuthService(), db: DBHelper()),
            ),
          ),
        ],
