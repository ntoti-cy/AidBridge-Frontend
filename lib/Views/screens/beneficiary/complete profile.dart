...
class _CompleteProfileState extends State<CompleteProfile> {
  ...
  Future<void> _loadCenters() async {
    try {
      final response = await DioClient.dio.get("/api/crud/get-centers");

      centers = List<Map<String, dynamic>>.from(response.data);
    } catch (_) {
      centers = [];
    }
  ...
  void _submitProfile() {
    ...
    if (selectedCenterId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          content: Text("Please choose a distribution centre."),
        ),
      );
    ...
    context.read<CrudCubit>().completeProfile({
      "total_members": int.parse(membersController.text.trim()),

      "dependents_count": int.parse(dependentsController.text.trim()),

      "income_level": double.parse(incomeController.text.trim()),

      "disability_present": disabilityPresent,
        ...
        child: BlocConsumer<CrudCubit, AuthState>(
          listener: (context, state) {
            if (state is ProfileCompleted) {
              ...
              Get.offAllNamed("/beneficiaryDashboard");
            }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (showOfflineBanner) _buildOfflineBanner(),
      ...
      child: Column(
        children: [
          _buildNumberField(
            ...
            validator: (value) => _numberValidator(value, "Household members"),
          ),
          ...
          _buildNumberField(
            ...
            validator: (value) => _numberValidator(value, "Dependents"),
          ),
  ...
  Widget _buildDisabilityCard() {
    return _buildSectionCard(
      ...
      child: SwitchListTile(
        ...
        title: const Text("Disability present"),
    ...
    return _buildSectionCard(
      ...
      child: loadingCenters
          ...
          : DropdownButtonFormField<int>(
              ...
              decoration: InputDecoration(
                labelText: "Select Distribution Centre",
  ...
  Widget _buildSubmitButton(AuthState state) {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        label: Text(
          state is AuthLoading ? "Submitting..." : "Finish Setup",
